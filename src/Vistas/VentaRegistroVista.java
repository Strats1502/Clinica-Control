...
public class VentaRegistroVista extends CustomVista {
    ...
    public static BeautyList listaFormaPago = new BeautyList(dlmFormaPago, 105, 290,110,50);
    ...
    private void componentes() {
        ...
        comboFormaPago = new BeautyComboBox("Forma de pago", 60, 270, 200,20);
    ...
    private class BotonGuardarActionListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (datosCompletos(folio, formaPago, tipoCliente, correoPaciente, nombre, apellidoPaterno, apellidoMaterno, municipio, colonia, calleNumero, activo)) {
                if (!editando) {
                    InsertarSQL.insertarVenta(1, folio, formaPago, tipoCliente, correoPaciente, nombre, apellidoPaterno, apellidoMaterno, municipio, colonia, calleNumero, activo);
                } else {
                    ActualizarSQL.actualizarVenta(folio, formaPago, tipoCliente, correoPaciente, nombre, apellidoPaterno, apellidoMaterno, municipio, colonia, calleNumero, activo);
                    InsertarSQL.insertarModificacion(id, 1, "Venta");
                }
            } else {
    ...
    private  boolean datosCompletos(String folio, String formaPago, String tipoCliente, String correo, String nombre, String apellidoPaterno, String apellidoMaterno, String municipio, String colonia, String calleNumero, boolean activo) {
                        ...
                        if (datosClienteCompletos(tipoCliente, correo, nombre, apellidoPaterno, apellidoMaterno)) {
                            if (!municipio.equals("Municipio")) {
                                if (!colonia.equals("Colonia")) {
                                    if (!calleNumero.equals("Calle/Número")) {
